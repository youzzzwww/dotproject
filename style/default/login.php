...
<tr>
	...
	<td align="left" nowrap><a href="#" onclick="f=document.loginform;f.lostpass.value=1;f.submit();"><?php echo $AppUI->_('forgotPassword');?></a></td>
	<td align="right" nowrap><a href="<?php echo DP_BASE_URL.'/register/register.php';?>">Register</a></td>
</tr>
</table>
...
<?php
	...
	$msg .= function_exists('mysqli_connect') ? '': '<br /><span class="warning">WARNING: PHP may not be compiled with MySQL support.  This will prevent proper operation of dotProject.  Please check you system setup.</span>';
	echo $msg;
?>
</div>
